...
public class WordCounter {
  ...
  public static void main(String args[]) throws IOException {
    ...
    System.out.println("Path of the input file?");
    input = sc.nextLine();
    System.out.println("Path of the output file?");
    output = sc.nextLine();
  ...
  public static String wordCount(String input_file, String output_file) throws IOException {
    ...
    for(int i=0; i<words.getData().length; i++) {
      if(words.getData()[i] != null) {
        ...
        while(curNode != null) {   //write out all the nodes linked together in each slot of the array
